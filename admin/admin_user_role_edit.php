...
<head>
  ...
  <?php
    ...
    {
        $insert_role_name = $_POST["insert_role_name"];
    $sql = "UPDATE `user_role` SET `user_role_name` = '$insert_role_name' WHERE `user_role`.`user_role_id` = $id;";
...
<div class="wrapper">
    ...
    <form method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $row[1]; ?>" name="insert_role_name" placeholder="Enter Name">
                  </div>
                
      
        <a href="./admin_user_role.php" class="btn btn-secondary">Go Back</a>
