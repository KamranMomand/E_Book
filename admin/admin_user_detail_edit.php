...
?>
  ...
  <?php
    ...
    $sql = "UPDATE `user_detail` SET `user_name` = '$insert_user_name', `user_email` = '$insert_user_email', `user_password` = '$insert_user_password', `user_role_id` = '$user_role' WHERE `user_detail`.`user_id` = $id;";
...
<div class="wrapper">
    ...
    <form method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $row[1]; ?>"  name="insert_user_name" placeholder="Enter Name">
                    <br>
                    <label for="exampleInputEmail1">User Email: </label>
                    <input type="email" class="form-control-file" value="<?php echo $row[2]; ?>"   name="insert_user_email" placeholder="Enter Email">
                    <br>
                    <label for="exampleInputEmail1">User Password:</label>
                    <input type="password" class="form-control" value="<?php echo $row[3]; ?>"  name="insert_user_password" placeholder="Enter Password">
                    <br>
                    ...
                    <select class="form-select" name="user_role" aria-label="Default select example">
                      ...
                      { if($role_row['user_role_id']==$row[4])
                        { ?>
                      <option value="<?php echo $role_row['user_role_id']; ?>"selected ><?php echo $role_row['user_role_name']; ?></option>
                    <?php } else { ?>
