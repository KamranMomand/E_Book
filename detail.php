...
<?php
    include "config.php";
    $cat_id = $_GET['id'];
    $mysql = "Select * from book_detail where book_id = '$cat_id'";
      ...
      <div class="row row-sm mt-5">
         <div class="col-md-6 _boxzoom">
            <div class="zoom-thumb">
               <ul class="piclist">
                   <?php
                    ...
                    ?>
                     <!-- <li><img src="uploads/<?php echo $images[$i]?>" alt=""></li>  -->
                    <?php
                        }
                   ?>
               </ul>
            ...
            <div class="_product-images">
               <div class="picZoomer">
               <img class="w-100" style="height:500px" src="data:jpg;charset=utf8;base64,<?php echo base64_encode($row['book_image']); ?>" alt="">
               </div>
            </div>
         </div>
         <div class="col-md-6">
            <div class="_product-detail-content">
               <p class="_p-name"><?php echo $row['book_name']?></p>
               <div class="_p-price-box">
                  <div class="p-list">
                     <!-- <span> M.R.P. : <i class="fa fa-inr"></i> <del> 1399  </del>   </span> -->
                     <span class="price"> Rs. <?php echo $row['book_price']?></span>
                  </div>
                  <form action="addto.php?id=<?php echo $row['book_id']?>" method="post">
